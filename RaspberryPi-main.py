#Created by Anushka Jain for the A.M.E.A. Project.
import time
import PIL
import pysstv
import cv2
...
"""def playSound(array, fs=8000):
    p = pyaudio.PyAudio()
    stream = p.open(format=pyaudio.paInt16, channels=2, rate=fs, output=True)
...
def imageProcessing(Deos):
    ...
    myFont = ImageFont.truetype('LiberationMono-Regular.ttf', 22)
